					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="cg_titleContainer">
								...
								<h1 class="cg_subtitle" style="text-align:center;color:red;">Mobile Application Development </h1>
								<h3 class="cg_text-center" style="text-align:center"> <i class="fa fa-quote-left" ></i> The future of mobile is the future of online <i class="fa fa-quote-right" ></i></h3>
                        ...
                        <article class="post cmt-blog-single clearfix">
                            ...
                            <div class="cmt-post-featured-wrapper cmt-featured-wrapper">
                                <div class="cmt-post-featured">
                                    <img class="img-fluid " src="../assets/img/all/android.jpg" alt="intermodel" style="max-width:92%">
                                </div>
                        ...
                        <div class="cg__imageBox">
                          <div class="cg__imageBox-wrapper">
                            <div class="cg__imageBox-imgWrapper">
                              <img src="../assets/img/services/mob1.jpg" alt="" style="max-width:88%;height:auto">
                            </div>
