...
<div class="container-fluid" style="background-color:#080e32;height: 130px;">
  



    <div class="section-title" >
                <h1 class="sub-title" style="color:red">About</h1>
    </div>
</div>
    <!-- <div class="shape2"><img src="../assets/img/shape/shape11.png" alt="image" /></div> -->
            <div class="shape3"><img src="../assets/img/shape/shape11.png" alt="image" /></div>
            <div class="shape5"><img src="../assets/img/shape/shape11.png" alt="image" /></div>
            <div class="shape6"><img src="../assets/img/shape/shape11.png" alt="image" /></div>
            <div class="shape7"><img src="../assets/img/shape/dots.png" alt="image" /></div>
            <div class="shape8"><img src="../assets/img/shape/shape11.png" alt="image" /></div>
            <div class="lines">
                <div class="line"></div>
                <div class="line"></div>
                <div class="line"></div>
            </div>
            <div class="bubbles" style="width:auto">
    ...
    <div class="container">
    <div class="section qntrl" id="section5">
            <div class="content-wrap bottom-animated animated middle-animated top-animated">
                <div class="section-wrapper">
                    <div class="section-main">
                        <h4 style="color:crimson">About Us</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tem</p>
                        <a class="cta" href="<?=site_url('about')?>" target="_blank">Read more</a> </div><a href="" target="_blank" class="section-logo"> <img class="main-logo" src="../assets/img/all/zio.jpg" alt="zip">
                        <p>Green Data Digital Technologies</p>
                    </a>
...
<section class="featured-services-area pt-100 pb-70">
        <div class="container">
            <div class="section-title">
                <span class="sub-title" style="color:red">Services</span>
                <h2>See Our Services</h2>
                <!--  <p>We are here to design what you need. Our team of professionals will create attractive designs to make your business stand out. No matter your business is small or large, we are here to make eye-catchy designs for your enterprise.</p> -->
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
                    <div class="single-featured-services-box">
                        ...
                        <h3><a href="web-design">Mobile App Development </a></h3>
                        <p style="font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                        <a href="<?=site_url('mobileapp');?>" class="learn-more-btn" > Learn More <i class="fi fi-br-arrow-right" ></i></a>                    </div>
                </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
                    <div class="single-featured-services-box">
                        <div class="icon">
                        ...
                        <h3><a href="web-development">Web App Development</a></h3>
                        <p style="font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                        <a href="<?=site_url('webapp');?>" class="learn-more-btn" > Learn More <i class="fi fi-br-arrow-right" ></i></a>                    </div>
                </div>
               ...
               <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
                    <div class="single-featured-services-box">
                        ...
                        <h3><a href="mobile-applications-development">Software Development</a></h3>
                        <p style="font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                        <a href="<?=site_url('softdev');?>" class="learn-more-btn" > Learn More <i class="fi fi-br-arrow-right" ></i></a>                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
                    <div class="single-featured-services-box">
                        ...
                        <h3><a href="digital-marketing">Software Testing</a></h3>
                        <p style="font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                        <a href="<?=site_url('softest');?>" class="learn-more-btn" > Learn More <i class="fi fi-br-arrow-right" ></i></a>
                    </div>
                </div>
               <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
                    <div class="single-featured-services-box">
                        ...
                        <h3><a href="#">Software Training</a></h3>
                        <p style="font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                        <a href="<?=site_url('softrain');?>" class="learn-more-btn" > Learn More <i class="fi fi-br-arrow-right" ></i></a>                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
                    <div class="single-featured-services-box">
                        <div class="icon">
                        ...
                        <h3><a href="#">Contract Staffing</a></h3>
                        <p style="font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                        <a href="<?=site_url('contract');?>" class="learn-more-btn" > Learn More <i class="fi fi-br-arrow-right" ></i></a>                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
    <div class="section-title" >
                <span class="sub-title" style="color:red">Products</span>
                <h2 style="text-align:center">See Our Portfolio</h2>
    </div>
    </div>

    <section class="portfolio-area ptb-100 pb-70">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-portfolio-box">
                            <a href="#" class="image d-block">
                                <img src="../assets/img/portfolio/templ.png" alt="image">
                            </a>
    
                            <div class="content">
                                <h3>Templ.</a></h3>
                                <span>Website Development</span>
                                <a href="<?=site_url('products');?>"><span class="readmore">Read More</span></a>
                                <a href="<?=site_url('products');?>" target="_blank" class="link-btn"><i class="fi fi-br-arrow-right"></i></a>
                            </div>
                        </div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-portfolio-box">
                            <a href="#" class="image d-block">
                                <img src="../assets/img/portfolio/thirumanam.png" alt="image">
                            </a>
    
                            <div class="content">
                                <h3>Thirumanam.online</a></h3>
                                <span>Website Development</span>
                               <a href="<?=site_url('products');?>"><span class="readmore">Read More</span></a>
                                <a href="<?=site_url('products');?>" target="_blank" class="link-btn"><i class="fi fi-br-arrow-right"></i></a>
                            </div>
					 ...
					 <!-- <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="single-portfolio-box">
                            <a href="portfolio-north-transportation" class="image d-block">
                                <img src="assets/img/portfolio/thenorthtrans_portfolio.jpg" alt="image">
                            </a>
    
                            <div class="content">
                                <h3><a href="portfolio-north-transportation">The North Transportation</a></h3>
                                <span>Website Development</span>
                                <a href="portfolio-north-transportation" class="link-btn"><i class="flaticon-next-button"></i></a>
                            </div>
                        </div>
