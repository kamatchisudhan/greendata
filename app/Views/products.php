    ...
    <div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="cg_titleContainer">
								<h4 class="cg_title" style="text-align:center;color:red">Products</h4>
								
								<h3 class="cg_text-center" style="text-align:center"> <i class="fa fa-quote-left" ></i> Our Portfolio <i class="fa fa-quote-right" ></i></h3>
								<span class="cg__symbol">
									<span></span>
								</span>
							</div><!--/.cg__welcome-titleContainer-->
						</div><!--/.col-md-12 col-sm-12-->
					<p class="cg_contact-titleBlock cg_text" style="font-size: 18px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tem.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tem</p>
					</div><!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="single-blog-post">
                    ...
                    <div class="content">
                        <h4><a href="http://tirumanam.in/" target="_blank">thirumanam.online is a leading Match Making online database with verified profiles-Matrimonial Site.A matrimonial app that connects various users according to their specificity.It contains chat options to communicate with users,payment gateway and secured authentication.<span style="color:red">Visit</span></a></h4>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="single-blog-post">
                    ...
                    <div class="content">
                        <h4><a href="http://templ.online/" target="_blank">A Hindu Temple can be simple structured by the side of the road or a large complex including many buildings.A wikipedia of indian temples and Pooja bookings apps,user interfaces are senior citizen friendly,matrimony options,event tracking for users,googlr map api implementation.<span style="color:red">Visit</span> </a></h4>
