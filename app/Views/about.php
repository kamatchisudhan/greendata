...
.menu-bar ul li:hover .dropdown-menu ul li:active {
color:red;
}
/* .dropdown-menu-1 {
  display: none;
...
<div class="about-container">
    ...
    <div class="image-container">
        <img src="../assets/img/round.jpg" alt="round-meeting">
        
    </div>

    <div class="text-container">
        <h1 style="color:red">About us</h1>
        <p style="font-size:18px">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eligendi porro rerum cupiditate expedita distinctio nisi nulla ipsum libero molestiae minima Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid,ipsum libero molestiae</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 mb-30 animate-box" data-animate-effect="fadeInUp">
                  <h3>What we do</h3>
                  <p style="font-size:18px">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eligendi porro rerum cupiditate expedita <br> distinctio nisi nulla ipsum libero molestiae minima Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid,ipsum libero molestiae</p>
...
-->
                ...
                <div class="col-md-5 offset-md-2 animate-box" data-animate-effect="fadeInUp">
                    <div class="about-img">
                        <div class="img"> <img src="../assets/img/all/about1.jpg" class="img-fluid" alt=""> </div>
                    </div>
                </div>
            </div>
        </div>
