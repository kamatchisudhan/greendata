					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="cg_titleContainer">
								...
								<h1 class="cg_subtitle" style="text-align:center;color:red">Web Application Development </h1>
								<h3 class="cg_text-center" style="text-align:center"> <i class="fa fa-quote-left" ></i> We connect the web network in future of online <i class="fa fa-quote-right" ></i></h3>
        ...
        <div class="cmt-row sidebar cmt-sidebar-right cmt-bgcolor-grey clearfix">
           ...
           <li class="learn-more"><a href="<?=site_url('contract');?>" class="nav-link">Contract Staffing </a></li>
                        ...
                        <article class="post cmt-blog-single clearfix">
                            ...
                            <div class="cmt-post-featured-wrapper cmt-featured-wrapper">
                                <div class="cmt-post-featured">
                                    <img class="img-fluid " src="../assets/img/all/webappd.jpg" alt="intermodel" style="max-width:92%">
                                </div>
                     ...
                     <div class="col-md-6 col-sm-6" style="background-color:white">
                                <h2>E-Commerce Web App Development</h2>
                        ...
                        <div class="cg__imageBox">
                          <div class="cg__imageBox-wrapper">
                            <div class="cg__imageBox-imgWrapper">
                              <img src="../assets/img/all/ecom.jpg" alt="" style="max-width:88%;height:auto" >
                            </div>
