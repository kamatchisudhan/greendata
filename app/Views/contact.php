    ...
    <div class="content">
      <div class="left-side">
        <div class="address details">
          ...
          <div class="text-one" style="font-size:16px" >48, opp. Hundai Showroom, Kudlu Gate, Krishna Reddy Industrial Area, Hosapalaya,</div>
          <div class="text-two"> Muneshwara Nagar, Bengaluru, Karnataka 560068</div>
        </div>
        <div class="phone details">
          <i class="fas fa-phone-alt" style="color:red"></i>
          <div class="topic" style="display:block">Phone</div><br>
          <div class="text-one" style="font-size:16px">+91 96065 18855</div>
          
        </div>
        <div class="email details">
          <i class="fas fa-envelope" style="color:red"></i>
          <div class="topic">Email</div><br>
          <div class="text-one" style="font-size:16px">greendatadigital@gmail.com</div>
                ...
                <div class="single-blog-post">
                    <div class="image">
                        <a href="#" class="d-block">
                            <img src="../assets/img/all/contact.jpg" alt="image"  style="filter:blur(8px);opacity:0.5">
                            <div class="topic-text" style="position:absolute;top:20%;left: 90px;font-size:27px;color:black" >How Can We Help?</div>
                            <p style="position:absolute;top:30%;left: 90px;font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>

                        </a>
                    </div>
                    <div class="content">
                    <a href="mailto:kamatchisudhan01@gmail.com?cc=sender@example.com&subject=Contact you&body=Hello%20Greendata%2C%0A%0AI%20am%20interested%20in%20learning%20more%20about%20your%20products.%0A%0AThank%20you%21&from=user@example.com" style="position:absolute;top:80%;left:250px;text-align:center" target="_blank" type="button" value="Send Now" class="btn btn-primary" name="submit">Contact Us</a>
                    <!-- <button class="contact-button"><a href="mailto:kamatchisudhan@gmail.com?cc=sender@example.com&subject=Contact Us">Contact Us</a></button> -->

                    </div>
                </div>
            </div>
          <!-- <img src="../assets/img/all/contact.jpg" alt="" style="background:#212b38;opacity:0.5">
         <div class="topic-text" style="position:absolute;top:20%;left: 100px;font-size:27px;" >How Can We Help?</div>
        <p style="position:absolute;top:30%;left: 100px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna..</p>

      <a href="mailto:kamatchisudhan01@gmail.com?subject=Contact Form Submission&body=Hello%20there%2C%0A%0AI%20am%20interested%20in%20learning%20more%20about%20your%20products.%0A%0AThank%20you%21&from=user@example.com" style="position:absolute;top:80%;left:250px;text-align:center" target="_blank" type="button" value="Send Now" class="btn btn-primary" name="submit">Contact Us</a> -->
      </div>
    </div>
    </div>
    </div>
