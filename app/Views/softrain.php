					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="cg_titleContainer">
								...
								<h1 class="cg_subtitle" style="text-align:center;color:red">Software Training </h1>
								<h3 class="cg_text-center" style="text-align:center"> <i class="fa fa-quote-left" ></i> 
Software comes from heaven when you have good hardware.<i class="fa fa-quote-right" ></i></h3>
                        ...
                        <article class="post cmt-blog-single clearfix">
                            ...
                            <div class="cmt-post-featured-wrapper cmt-featured-wrapper">
                                <div class="cmt-post-featured">
                                    <img class="img-fluid " src="../assets/img/all/train.jpg" alt="intermodel"  style="max-width:92%">
                                </div>
                        ...
                        <div class="cg__imageBox">
                          <div class="cg__imageBox-wrapper">
                            <div class="cg__imageBox-imgWrapper">
                              <img src="../assets/img/all/group.jpg" alt=""  style="max-width:88%;height:auto">
                            </div>
